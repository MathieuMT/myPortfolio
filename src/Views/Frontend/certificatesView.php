...
<div class="heading">
 ...
 animated fadeInLeft">
        <?= $this->title = 'Portfolio - Mes certificats' ?>
    </h1>
        ...
        <div class="container containerGallery" id="uploadedFiles">
            ...
            <div class="galleryOne">
                ...
                <div class="row rowGallery">
                    ...
                    <div id="<?= $eachCertificate->id(); ?>" class="col-md-6 col-lg-4 animated fadeInLeft">
                        ...
                        <div class="card border-0 transform-on-hover">
                            ...
                            <div class="card-body">
                                ...
                                <h6><b><?= $eachCertificate->name(); ?></b>
                                    <?= $eachCertificate->certificatTitle(); ?>
                                </h6><br />

                                <p class="text-muted card-text">
                                    <?= $eachCertificate->certificatDescription(); ?>
                                </p>

...
<h1 class="text-center titlePage"><?= $this->title = 'Contactez-moi' ?></h1>
...
<!-- Google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAhujcCt5Q8480AuaNBhLuw-UQPmg4wgo4&callback=initMap"
    async defer></script>

...
function delImg(id) {
    ...
    if (id === 0) 
        ...
        $.ajax({
            url: 'index.php?action=uploadWorksImages',
            method: 'POST',
            dataType: 'text',
            data: {
                delImage: 1,

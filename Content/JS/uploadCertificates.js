...
function delImg(id) {
    ...
    if (id === 0) 
        ...
        $.ajax({
            url: 'https://mmtmc.alwaysdata.net/index.php?action=uploadCertificatesImages',
            method: 'POST',
            dataType: 'text',
            data: {
                delImage: 1,
